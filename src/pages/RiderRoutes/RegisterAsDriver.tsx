import register from "@/assets/images/contact.jpg";
import { Link } from "react-router";
import Logo from "@/assets/icons/Logo";
import { DriverRegisterForm } from "@/components/modules/Rider/DriverRegisterForm";

export default function RegisterAsDriver() {
  return (
    <>
      <section
        className="relative flex min-h-screen items-center justify-center bg-cover bg-center py-20"
